...
namespace cryptopalschallenge
{
    ...
    public class Challenge06
    {
        ...
        public string DoChallenge06()
        {
            ...
            int lowestKeySize = RepeatingKeyXOR.FindKeySize(encryptedData);
